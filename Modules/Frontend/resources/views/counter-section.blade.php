...
@section('admin-content')
    <div class="main-content">
        <section class="section">
            <x-admin.breadcrumb title="{{ __('Counter Section') }} ( {{$current_theme_title}} )" :list="[
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <x-admin.form-input id="project_title" data-translate="true" name="project_title"
                                                    label="{{ __('Project Title') }}" placeholder="{{ __('Project Title') }}"
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <x-admin.form-textarea id="project_sub_title" name="project_sub_title"
                                                    label="{{ __('Project Sub Title') }}"
                                                    placeholder="{{ __('Project Sub Title') }}" data-translate="true"
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <x-admin.form-input id="customer_title" data-translate="true" name="customer_title"
                                                    label="{{ __('Customer Title') }}" placeholder="{{ __('Customer Title') }}"
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <x-admin.form-textarea id="customer_sub_title" name="customer_sub_title"
                                                    label="{{ __('Customer Sub Title') }}"
                                                    placeholder="{{ __('Customer Sub Title') }}" data-translate="true"
