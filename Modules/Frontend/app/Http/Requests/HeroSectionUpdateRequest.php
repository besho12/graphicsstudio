...
class HeroSectionUpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        $rules = [
            ...
            'hero_year_image'    => ['nullable', 'mimetypes:image/jpeg,image/png,image/gif,image/webp,image/svg+xml', 'max:512'],
            'total_customers'    => ['nullable', 'string', 'max:255'],
            'image_two'          => ['nullable', 'mimetypes:image/jpeg,image/png,image/gif,image/webp,image/svg+xml', 'max:512'],
