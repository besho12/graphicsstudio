                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="tab-content" id="myTabContent2">
                                    ...
                                    @include('globalsetting::settings.sections.shop')
...
@push('js')
    ...
    <script>
        ...
        $.uploadPreview({
            input_field: "#pricing_page_breadcrumb_image_upload",
            preview_box: "#pricing_page_breadcrumb_image_preview",
            label_field: "#pricing_page_breadcrumb_image_label",
            label_default: "{{ __('Choose Image') }}",
            label_selected: "{{ __('Update Image') }}",
            no_label: false,
            success_callback: null
        ...
        $.uploadPreview({
            input_field: "#shop_page_breadcrumb_image_upload",
            preview_box: "#shop_page_breadcrumb_image_preview",
            label_field: "#shop_page_breadcrumb_image_label",
            label_default: "{{ __('Choose Image') }}",
            label_selected: "{{ __('Update Image') }}",
            no_label: false,
            success_callback: null
        ...
        $.uploadPreview({
            input_field: "#cart_page_breadcrumb_image_upload",
            preview_box: "#cart_page_breadcrumb_image_preview",
            label_field: "#cart_page_breadcrumb_image_label",
            label_default: "{{ __('Choose Image') }}",
            label_selected: "{{ __('Update Image') }}",
            no_label: false,
            success_callback: null
        ...
        $.uploadPreview({
            input_field: "#checkout_page_breadcrumb_image_upload",
            preview_box: "#checkout_page_breadcrumb_image_preview",
            label_field: "#checkout_page_breadcrumb_image_label",
            label_default: "{{ __('Choose Image') }}",
            label_selected: "{{ __('Update Image') }}",
            no_label: false,
            success_callback: null
        ...
        $.uploadPreview({
            input_field: "#payment_page_breadcrumb_image_upload",
            preview_box: "#payment_page_breadcrumb_image_preview",
            label_field: "#payment_page_breadcrumb_image_label",
            label_default: "{{ __('Choose Image') }}",
            label_selected: "{{ __('Update Image') }}",
            no_label: false,
            success_callback: null
