...
<li class="nav-item">
    <a class="nav-link" id="shop-tab" data-bs-toggle="tab" href="#shop_tab" role="tab"
        aria-controls="shop" aria-selected="true">{{ __('Shop Setting') }}</a>
</li>
<li class="nav-item">
...
<li class="nav-item">
    <a class="nav-link" id="search-engine-crawling-tab" data-bs-toggle="tab" href="#search-engine-crawling" role="tab"
        aria-controls="search-engine-crawling" aria-selected="false">{{ __('Search Engine Crawling') }}</a>
</li>
<li class="nav-item">
