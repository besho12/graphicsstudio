                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="tab-content" id="myTabContent4">
                                    ...
                                    @include('basicpayment::sections.cash-on-delivery')
...
@push('js')
    ...
    <script>
        ...
        $.uploadPreview({
            input_field: "#cash_on_delivery_image_upload",
            preview_box: "#cash_on_delivery_image_preview",
            label_field: "#cash_on_delivery_image_label",
            label_default: "{{ __('Choose Image') }}",
            label_selected: "{{ __('Change Image') }}",
            no_label: false,
            success_callback: null
