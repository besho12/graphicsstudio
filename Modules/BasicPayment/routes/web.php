...
Route::group(['as' => 'admin.', 'prefix' => 'admin', 'middleware' => ['auth:admin','translation']], function () {
    ...
    Route::controller(BasicPaymentController::class)->group(function () {
        ...
        Route::put('update-cash-on-delivery-payment', 'update_cash_on_delivery_payment')->name('update-cash-on-delivery-payment');
...
Route::group(['middleware' => ['auth', 'verified']], function () {
    Route::controller(PaymentController::class)->group(function () {
        ...
        Route::post('pay-cash-on-delivery', 'pay_cash_on_delivery')->name('pay-cash-on-delivery');
        ...
        Route::view('order-success', 'basicpayment::order_success')->name('order-success');
        Route::view('order-failed', 'basicpayment::order_failed')->name('order-failed');
    });
