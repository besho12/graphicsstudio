<div class="hero-wrapper hero-2" id="hero">
    ...
    <div class="container">
        <div class="hero-style2">
            <div class="row">
                <div class="col-lg-9">
                    <h1 class="hero-title wow img-custom-anim-right text-white">{{$hero?->content?->title}}</h1>
                    <h1 class="hero-title wow img-custom-anim-left text-white">{{$hero?->content?->title_two}}</h1>
                </div>
                <div class="col-lg-10 offset-lg-2">
                    <h1 class="hero-title wow img-custom-anim-right text-white">{{$hero?->content?->title_three}}</h1>
                </div>
