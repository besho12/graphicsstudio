...
<section class="portfolio-modern-section" id="portfolio-section">
    <div class="portfolio-content-modern">
        ...
        <div class="section-header-modern">
            ...
            <p class="section-subtitle">{{ __('Explore our portfolio of innovative solutions and creative designs that have helped our clients achieve their goals') }}</p>
        </div>
                ...
                @foreach($projects->take(6) as $project)
                    <div class="portfolio-card-modern" data-category="{{ Str::slug($project->project_category) }}" data-aos="fade-up" data-aos-delay="{{ $loop->index * 100 }}">
                        ...
                        <div class="portfolio-content">
                            ...
                            <p class="portfolio-description">{{ Str::limit($project->description, 80) }}</p>
