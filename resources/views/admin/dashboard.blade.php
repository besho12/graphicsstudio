                        ...
                        @if ($setting?->is_shop)
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                                <div class="card card-statistic-1">
                                    ...
                                    <div class="card-wrap">
                                        <div class="card-header">
                                            <h4>{{ __('Active Product') }}</h4>
                                        </div>
                                        <div class="card-body">
                                            {{ count($total_active_product) }}
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                                <div class="card card-statistic-1">
                                    ...
                                    <div class="card-wrap">
                                        <div class="card-header">
                                            <h4>{{ __('Pending Product') }}</h4>
                                        </div>
                                        <div class="card-body">
                                            {{ count($total_inactive_product) }}
                                        </div>
                                    </div>
                                </div>
                            </div>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    ...
                                                                    <div class="table-links">
                                                                        <a
                                                                            href="{{ route('shop', ['category' => $product?->category?->slug]) }}">{{ $product?->category?->title }}</a>
                                                                        <div class="bullet"></div>
                                                                        <a
                                                                            href="{{ route('single.product', $product?->slug) }}"><i
                                                                                class="fas fa-eye"></i>
                                                                            {{ $product?->views ?? 0 }}</a>
                                                                    </div>
                                                                </td>
                                    ...
                                    <div class="p-0 card-body">
                                        <div class="table-responsive">
                                            <table class="table mb-0 table-striped">
                                                ...
                                                <tbody>
                                                    @forelse ($latestCustomers as $user)
                                                        <tr>
